...
let user_services = (() => {
    ...
    let _classThis;
    var user_services = _classThis = class {
        register(body) {
        ...
        login(body) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!user) {
                    throw new appError_1.app_error(404, "User not registered");
                }
                const compare = yield bcrypt_1.default.compare(body.password, user.password);
                if (!compare) {
                    throw new appError_1.app_error(403, "Email and password doens't match");
                }
        ...
        getUser(id) {
            return __awaiter(this, void 0, void 0, function* () {
                const user = yield prisma_1.prisma.user.findFirst({ where: { id: id } });
                return user_schemas_1.userReturnSchema.parse(user);
            });
        }
    };
    __setFunctionName(_classThis, "user_services");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        user_services = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return user_services = _classThis;
})();
exports.user_services = user_services;
